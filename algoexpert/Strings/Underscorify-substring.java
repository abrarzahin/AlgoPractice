...
class Program {
	// Average case : O(n+m)
	// Space: O(n)
  public static String underscorifySubstring(String str, String 
substring) {
    
		List<Integer[]> locations = collapse(getLocations(str, 
substring));
		
    return underscorify(str, locations);
  }
	
	public static List<Integer[]> getLocations(String str, String 
substring){
		...
		while(startIdx < str.length()){
			...
			if( nextIdx != -1){
				locations.add(new Integer[] {nextIdx, 
nextIdx+substring.length()});
				startIdx = nextIdx+1;
			} else {
				break;
			}
	...
	public static List<Integer[]> collapse(List<Integer[]> 
locations){
...
ArrayList<Integer[]>();
	...
	public static String underscorify(String str, List<Integer[]> 
locations){
		...
		while( stringIdx < str.length() && locationsIdx < 
locations.size()){
