class Solution {
    /* Time Complexity: O(N), where N is the size of the grid.First, we scan the grid to find the initial values for the queue, which would take O(N) time.
